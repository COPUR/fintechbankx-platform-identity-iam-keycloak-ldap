...
- **Repo Kümesi:** `platform-identity`
- **Bounded Context:** `identity`
- **Ana Capability:** Centralized IAM, Keycloak, LDAP integration
- **Dönüşüm Wave:** 0
...
- `Centralized IAM, Keycloak, LDAP integration` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
